...
export default function useShakaABR(selectedTrack: SelectedTrackInfo, player: any){
    ...
    useEffect(() => {
        ...
        try {
            ...
            const track = player.getVariantTracks().find((track:any) => +track.id === selectedTrack.id);
            if (track) {
